...
Crypto.mode = {}
var b1 = Crypto.SHA1 = function(e, c) {
	var d = a.wordsToBytes(b1._sha1(e));
...
b1._sha1 = function(k) {
	...
	for (var y = 0; y < u.length; y += 16) {
		...
		for (var x = 0; x < 80; x++) {
			...
			var r = ((q << 5) | (q >>> 27)) + f + (o[x] >>> 0) + (x < 20 ? (p & h | ~p & g) + 1518500249 : x < 40 ? (p ^ h ^
				g) + 1859775393 : x < 60 ? (p & h | p & g | h & g) - 1894007588 : (p ^ h ^ g) - 899497514);
			f = g;
			g = h;
			h = (p << 30) | (p >>> 2);
			p = q;
